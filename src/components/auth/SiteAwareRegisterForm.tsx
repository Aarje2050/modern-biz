// src/components/auth/SiteAwareRegisterForm.tsx - ENHANCED WITH GOOGLE OAUTH
'use client'
...
export default function SiteAwareRegisterForm() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // For new registrations, we typically want to redirect to dashboard
      const redirectUrl = new URL(callbackUrl)
      redirectUrl.searchParams.set('redirect_to', '/dashboard')
  ...
  // Email registration handler (existing logic)
        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 border-t-4 border-red-600">
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
              {googleLoading ? (
                <>
          ...
          {/* EMAIL REGISTRATION FORM (Secondary) */}
