...
// Additional component for role-based navigation
export function DashboardNavigation({ userRole }: { userRole: UserRole }) {
  const navItems = [
    // Common items
    { name: 'Dashboard', href: '/dashboard', roles: ['all'] },
    
    // User-specific items
    { name: 'Saved Businesses', href: '/saved', roles: ['user', 'business', 'admin'] },
    { name: 'Profile', href: '/profile', roles: ['all'] },
    
    // Business owner items
    { name: 'My Businesses', href: '/dashboard/businesses', roles: ['business', 'admin'] },
    { name: 'Analytics', href: '/dashboard/analytics', roles: ['business', 'admin'] },
    { name: 'Customers', href: '/dashboard/crm/contacts', roles: ['business', 'admin'] },
    { name: 'Leads', href: '/dashboard/crm/leads', roles: ['business', 'admin'] },
    { name: 'Tasks', href: '/dashboard/crm/tasks', roles: ['business', 'admin'] },
    
    // Admin items
    { name: 'Platform Management', href: '/admin', roles: ['admin'] },
    { name: 'Business Management', href: '/admin/businesses', roles: ['admin'] },
    { name: 'User Management', href: '/admin/users', roles: ['admin'] },
    { name: 'Platform Analytics', href: '/admin/analytics', roles: ['admin'] },
  ]

  const getCurrentRole = () => {
    if (userRole.is_admin) return 'admin'
    if (userRole.has_businesses) return 'business'
    return 'user'
  }
